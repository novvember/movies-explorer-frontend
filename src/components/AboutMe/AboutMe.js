  ...
  return (
    <article className="about-me">
      ...
      <p className="about-me__description">
        ...
        понятные для пользователей интерфейсы, а&nbsp;также учитывать требования
        стандартов по&nbsp;семантике и&nbsp;доступности. Хочу продолжать изучать
        и&nbsp;использовать современные веб-технологии, приемы и&nbsp;софт
